...
#define INH 4.04		// Concentracion de inhibidor, en micromolar
#define KI 4.04		// Afinidad por el inhibidor, en micromolar
   ...
   */
   ...
   while(flag == 0)
   {
	 ...
	 if(n[0]>3099)
	    ...
	    // Termina el tiempo de observacion
	    if(n[1]>=0.95*A_acc)
	       break;	    
	 }
	 ...
	 vel_prom+=vel;
      ...
      // Registra concentraciones de sustancias
      fprintf(dptr,"%lf \t %lf \t %lf\t %lf \n",cA/km0,vel_prom/vmax0,v_teor/vmax0,0.5*v_teor/vmax0); 
